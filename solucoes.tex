...
\begin{document}
    ...
    \paragraph{1.}
    Da 1$^a$ hipótese, segue que: $x \in X \Rightarrow x \in A$ e $x \in X \Rightarrow x \in B$. Assim, todo elemento de X pertence também aos conjuntos A e B. Portanto, $x \in X \Rightarrow x \in A$ e $x \in B$. Logo, $x \in X \Rightarrow x \in (A\cap B)$. Donde concluímos que $X \subset (A \cap B)$.
